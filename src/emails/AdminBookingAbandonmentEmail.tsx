...
export type AdminBookingAbandonmentEmailProps = {
  bookingRef: string;
  customerName?: string;
...
export default function AdminBookingAbandonmentEmail({
  ...
  occasionDetails = [],
  addonItems = [],
}: AdminBookingAbandonmentEmailProps) {
  ...
  const headerTitle = isPaymentDropoff
      ...
      >
        <tbody>
              ...
              <BookingEmailSummaryPanel palette={color}>
                <table role="presentation" cellPadding={0} cellSpacing={0} style={{ width: "100%" }}>
                  <tbody>
                    ...
                    <BookingEmailDataRow
                      label="Reason"
                      value={cancelledReason || "SESSION_EXPIRED"}
                      labelColor={color.textSecondary}
                    />
                    <BookingEmailDataRow
                      label="Abandoned At"
          ...
          <tr>
            ...
            >
              Automated abandonment alert for follow-up.
            </td>
          </tr>
        </tbody>
      </table>
